...
def build_presentation():
    ...
    visual_add_kpi_chip(slide, 0.8, 4.0, 1.9, "Revenue", "$40.0bn", (230, 244, 241))
    visual_add_kpi_chip(slide, 2.95, 4.0, 1.9, "Net income", "$20.1bn", (230, 244, 241))
    visual_add_kpi_chip(slide, 5.1, 4.0, 1.9, "Revenue", "$32.8bn", (254, 226, 226))
    visual_add_kpi_chip(slide, 7.25, 4.0, 1.9, "Net income", "$15.0bn", (254, 226, 226))
